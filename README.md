...
**Linux / macOS:**
```bash
curl -fsSL https://raw.githubusercontent.com/LuaMastery/LunaSpeech/v0.9.1/scripts/install.sh | bash
```

**Windows** (PowerShell):
```powershell
irm https://raw.githubusercontent.com/LuaMastery/LunaSpeech/v0.9.1/scripts/install.ps1 | iex
```
...
> Release **v0.9.1**: <https://github.com/LuaMastery/LunaSpeech/releases/tag/v0.9.1>
